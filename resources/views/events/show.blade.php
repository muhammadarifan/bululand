...
<div class="min-h-screen bg-gray-50">
    <div class="bg-linear-to-r from-blue-600 to-blue-800 text-white py-4 px-6 shadow-md">
    ...
    <div class="max-w-7xl mx-auto mt-2 px-4">
        <div class="bg-red-50 border border-red-200 text-red-700 px-6 py-4 rounded-lg">
            ...
            <p class="mt-1">Tidak ada data kontribusi untuk "<span class="font-semibold">{{
    ...
    {{-- HERO IMAGE --}}
    <div class="relative w-full h-100 bg-gray-800">
        <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?w=1600&h=400&fit=crop" alt="Hero Image"
            class="w-full h-full object-cover opacity-80">
        <div class="absolute inset-0 bg-linear-to-b from-blue-900/60 to-blue-900/40"></div>
        <div class="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
            <h2 class="text-4xl md:text-5xl font-bold text-white mb-4">Selamat Datang di Event {{ ucfirst($event) }}
            </h2>
        ...
        <div class="bg-white rounded-xl shadow-lg p-2">
            <form method="GET" action="{{ route('events.show', $event) }}" class="flex items-center">
                <div class="flex-1 relative">
                    ...
                    <input type="text" name="search" placeholder="Masukkan nama rumah untuk cek pembayaran..."
                        value="{{ $searchQuery }}"
                        class="w-full pl-12 pr-4 py-3.5 text-gray-700 bg-gray-50 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-blue-500 focus:bg-white transition text-lg">
                </div>
                <button type="submit"
                    class="ml-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3.5 rounded-lg transition flex items-center gap-2">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-gray-700 text-right">Rp {{ number_format($result['paid_amount'], 0,
                            ',', '.') }}</td>
                        <td class="px-6 py-4 text-center">
                            @if ($result['paid_amount'] > 0)
                            <span
                                class="inline-block bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm font-medium">Sudah
                                Bayar</span>
                            @else
                            <span
                                class="inline-block bg-red-100 text-red-700 px-3 py-1 rounded-full text-sm font-medium">Belum
                                Bayar</span>
                            @endif
                        </td>
                    </tr>
    ...
    <main class="max-w-7xl mx-auto px-4 py-12 space-y-16">
        ...
        <section>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 mt-6 flex items-center justify-between">
                ...
                <p
                    class="text-3xl font-bold {{ ($totalIncome - $totalExpense) >= 0 ? 'text-green-600' : 'text-red-600' }}">
            ...
            <div class="space-y-4 max-w-4xl mx-auto">
                ...
                <div class="bg-white rounded-lg shadow-md border-l-4 border-red-500 p-6 hover:shadow-lg transition">
                    <div class="flex items-start gap-4">
                        <div class="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center shrink-0 mt-1">
